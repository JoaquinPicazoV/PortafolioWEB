        ...
        <div className="w-full grid bg-white p-5 md:flex">
            ...
            <div className="md:w-1/2 flex justify-center items-center">
                <div className="grid grid-cols-2 grid-rows-2 gap-4 md:grid-cols-1 md:grid-rows-4 xl:grid-cols-2 xl:grid-rows-2">
                    <div className="shadow bg-red-100 flex flex-col justify-center rounded border border-red-200 p-3 w-full max-w-[200px] h-[150px]">
                        <h1 className="text-black font-bold">Área</h1>
                        <div className="w-full">
                            <p className="text-black text-lg font-bold break-words leading-snug hyphens-auto">
                                Ciberseguridad
                            </p>
                    ...
                    <div className="shadow bg-red-100 flex flex-col justify-center rounded border border-red-200 p-3 w-full max-w-[200px] h-[150px]">
                        ...
                        <div>
                            <p className="text-black text-lg font-bold break-words leading-snug hyphens-auto">Estudiando Ing. Civil Informática</p>
